...
class PantsRunIntegrationTest(unittest.TestCase):
  ...
  # TODO: ideally this would be pants.pex and we could drop SafePantsRunIntegrationTest, but we
  #  cannot do this yet due to this being a public API. We're waiting to start the deprecation
  #  until we formalize a bit more how to automatically generate pants.pex, as proposed in
  #  https://github.com/pantsbuild/pants/pull/8183#pullrequestreview-279891498.
...
class SafePantsRunIntegrationTest(PantsRunIntegrationTest):
  """Integration test that works with --chroot and V2 Python test runner."""

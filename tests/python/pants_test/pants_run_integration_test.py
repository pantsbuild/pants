...
class PantsRunIntegrationTest(unittest.TestCase):
  ...
  # (https://github.com/pantsbuild/pants/pull/8185). We cannot have a directory
  ...
  # find the build root, because we could not depend on `./pants` for this.
  #
  # NB: this is a generated file that gets automatically generated by
  # `pants-plugins/../bootstrap_pants_pex_hook` and `build-support/bin/bootstrap_pants_pex.sh`.

...
class Target(Struct, HasStructs):
  ...
  def configurations(self):
    ...
    :rtype list of :class:`pants.engine.v2.configuration.Struct`
    """
...
def setup_json_scheduler(build_root, debug=True):
  ...
  :rtype A tuple of :class:`pants.engine.v2.scheduler.LocalScheduler`,
    :class:`pants.engine.v2.storage.Storage`.
  """

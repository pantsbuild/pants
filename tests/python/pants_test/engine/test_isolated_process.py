...
from pants.engine.scheduler import StepContext
...
class IsolatedProcessTest(SchedulerTestBase, unittest.TestCase):
  ...
  def test_gather_snapshot_of_pathglobs(self):
    ...
    empty_step_context = StepContext(None, node_builder=None, project_tree=project_tree, node_states=[], inline_nodes=False)

...
class PathsTest(ConsoleTaskTestBase):
    ...
    def test_single_edge_path(self):
        ...
        self.assert_console_output("Found 1 path", "", "\t[a, b]", targets=[target_a, target_b])

    def test_same_target_path(self):
        target_b = self.make_target("b")

        self.assert_console_output("Found 1 path", "", "\t[b]", targets=[target_b, target_b])
    ...
    def test_cycle_no_path(self):
        ...
        self.assert_console_output("Found 0 paths", targets=[target_a, target_b])
...
class PathTest(ConsoleTaskTestBase):
    ...
    def test_only_returns_first_path(self):
        ...
        self.assert_console_output("[a, inner1, b]", targets=[target_a, target_b])

    def test_when_no_path(self):
        target_b = self.make_target("b")
        target_a = self.make_target("a")

        self.assert_console_output("No path found from a to b!", targets=[target_a, target_b])

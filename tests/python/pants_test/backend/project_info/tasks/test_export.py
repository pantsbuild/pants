    ...
    def setUp(self):
        ...
        for empty_target in [
            ...
            for unused_scala_version in ["2_10", "2_11"]:
                self.make_target(f":{empty_target}_{unused_scala_version}", Target)
        self.make_target(":scalac-plugin-dep", Target)
        ...
        self.make_target(":scalastyle_2_12", Target)
        self.make_target(":scalastyle", Target)

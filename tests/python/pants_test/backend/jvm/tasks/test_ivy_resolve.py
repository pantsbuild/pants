...
class IvyResolveTest(NailgunTaskTestBase):
    ...
    def test_resolve_symlinked_cache(self):
        ...
        not the symlink'ed path we are expecting for --ivy-cache-dir.  Make sure that resolve
        correctly recognizes these as belonging in the cache dir and lookups for either the
        symlinked cache dir or the realpath to the cache dir are recognized.
        """

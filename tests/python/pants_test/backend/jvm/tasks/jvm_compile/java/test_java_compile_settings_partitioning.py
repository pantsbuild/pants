...
class JavaCompileSettingsPartitioningTest(NailgunTaskTestBase):
    ...
    def test_java_home_extraction_missing_distributions(self):
        ...
        def fake_distributions(versions):
            """Create a fake JDK for each java version in the input, and yield
            the list of java_homes.
        ...
        def fake_distribution_locator(*versions):
            ...
            Creates one distribution for each java version passed as an
            argument, and yields a list of paths to the java homes for
            each distribution.
            """

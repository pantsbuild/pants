...
class JunitTestsConcurrencyIntegrationTest(PantsRunIntegrationTest):
    ...
    Note that each of these tests is intended to be annotated with @ensure_experimental and run
    twice, once with the experimental runner enabled and once with it off.
    """

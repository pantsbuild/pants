...
class TestJvmAppIntegrationTest(PantsRunIntegrationTest):
    def test_bundle(self):
        ...
        Verify synthetic jar contains only a manifest file and the rest
        bundle contains other library jars.
        """
        self.assertEqual(
    ...
    def test_bundle_deployjar(self):
        ...
        Verify monolithic jar is created with manifest file and the
        library class.
        """
        self.assertEqual(
            "Hello world from Foo\n",

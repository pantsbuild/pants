...
def test_list_testproject() -> None:
    ...
    assert pants_run.stdout.strip() == "\n".join(
        [
            ...
            "testprojects/src/python/hello/__init__.py:hello",
            ...
            "testprojects/src/python/hello/greet/__init__.py:greet",
            "testprojects/src/python/hello/greet/greet.py:greet",

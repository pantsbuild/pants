...
Exception message: name 'a_is_bad' is not defined
 while executing BUILD file FilesystemBuildFile\((/[^/]+)*/bad/a/BUILD, FileSystemProjectTree\(\)\)
 Loading addresses from 'bad/a' failed\.
.*
Exception message: name 'b_is_bad' is not defined
 while executing BUILD file FilesystemBuildFile\((/[^/]+)*T/bad/b/BUILD, FileSystemProjectTree\(\)\)

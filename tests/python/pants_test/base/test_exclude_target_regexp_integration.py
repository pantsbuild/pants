...
class ExcludeTargetRegexpIntegrationTest(PantsRunIntegrationTest):
    ...
    def test_single_run(self):
        ...
        self._test_bundle_existences([Bundles.lesser_of_two.full_spec], [Bundles.lesser_of_two])
    ...
    def test_all_run(self):
        ...
        self._test_bundle_existences([Bundles.phrase_path + "::"], Bundles.all_bundles)

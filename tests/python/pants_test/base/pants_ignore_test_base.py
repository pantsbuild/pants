...
class PantsIgnoreTestBase(ProjectTreeTestBase):
    ...
    def test_ignore_pattern_negate(self):
        ...
        self.assertEqual(
            self._all_files - {"orange", "fruit/orange", "fruit/fruit/orange"}, set(files_list)
        )
    ...
    def test_ignore_pattern_two_asterisks(self):
        ...
        self.assertEqual(
            self._all_files - {"apple", "fruit/apple", "fruit/fruit/apple"}, set(files_list)
        )
    ...
    def test_ignore_dir_path_ignore_2(self):
        ...
        self.assertEqual(
            {"apple", "banana", "orange", "grocery"}, set(self._project_tree.glob1("", "*"))
        )
        self.assertEqual(
            {"apple", "banana", "orange", "grocery"},

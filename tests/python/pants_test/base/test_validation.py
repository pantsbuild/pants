...
class ParseValidation(unittest.TestCase):
    ...
    def test_invalid_inputs(self):
        ...
        with self.assertRaises(ValueError):
            assert_list(
                None, can_be_none=False
            )  # The default is ok as None only when can_be_noe is true
        with self.assertRaises(ValueError):
    ...
    def test_invalid_inputs_with_key_arg(self):
        ...
        with self.assertRaisesRegex(ValueError, "In key 'jars':"):
            assert_list(
                None, can_be_none=False, key_arg="jars"
            )  # The default is ok as None only when can_be_none is true

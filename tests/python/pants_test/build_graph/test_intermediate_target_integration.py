...
class IntermediateTargetIntegrationTest(PantsRunIntegrationTest):
    def test_scoped(self):
        ...
        stdout_list = (
            self.run_pants(["-q", "list", "{}:".format(test_path)]).stdout_data.strip().split()
        )

        hash_1 = hash_target(scoped_address, "compile")
        hash_2 = hash_target(scoped_address, "runtime")
        self.assertIn(
            "testprojects/src/java/org/pantsbuild/testproject/runtime:gson-unstable-compile-{}".format(
                hash_1
            ),
            stdout_list,
        )
        ...
        self.assertIn(
            "testprojects/src/java/org/pantsbuild/testproject/runtime:gson-unstable-runtime-{}".format(
                hash_2
            ),
            stdout_list,
        )
    ...
    def test_intransitive(self):
        ...
        self.assertIn(
            "testprojects/src/java/org/pantsbuild/testproject/intransitive:b-unstable-{}-{}".format(
                suffix, hash_b
            ),
            stdout_list,
        )
        ...
        self.assertIn(
            "testprojects/src/java/org/pantsbuild/testproject/intransitive:c-unstable-{}-{}".format(
                suffix, hash_c
            ),
            stdout_list,
        )
    ...
    def test_provided(self):
        ...
        self.assertIn(
            "testprojects/maven_layout/provided_patching/one/src/main/java:shadow-unstable-{}-{}".format(
                suffix, hash_1
            ),
            stdout_list,
        )
        ...
        self.assertIn(
            "testprojects/maven_layout/provided_patching/two/src/main/java:shadow-unstable-{}-{}".format(
                suffix, hash_2
            ),
            stdout_list,
        )
        ...
        self.assertIn(
            "testprojects/maven_layout/provided_patching/three/src/main/java:shadow-unstable-{}-{}".format(
                suffix, hash_3
            ),
            stdout_list,
        )
        ...
        self.assertIn(
            "testprojects/maven_layout/provided_patching/leaf:shadow-unstable-{}-{}".format(
                suffix, hash_2
            ),
            stdout_list,
        )

...
class ProjectsTestBase(PantsRunIntegrationTest):
    ...
    def skipped_targets(self) -> List[str]:
        ...
        negative_test_targets = [
            ...
            "testprojects/src/scala/org/pantsbuild/testproject/compilation_warnings:fatal_compiler_options",
            "testprojects/src/scala/org/pantsbuild/testproject/compilation_warnings:fatal_explicit",

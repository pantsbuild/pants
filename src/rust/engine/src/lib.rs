...
pub extern "C" fn scheduler_create(
  ...
  construct_parse_call: Function,
  construct_parse_call_index: Function,
  construct_parse_output: Function,
  construct_parse_function: Function,
  ...
  type_parse_input: TypeConstraint,
  type_parse_output: TypeConstraint,
  type_string: TypeId,
  type_bytes: TypeId,
  ...
  let types = Types {
    ...
    string: type_string,
    bytes: type_bytes,
    parse_input: type_parse_input,
    parse_output: type_parse_output,
  };

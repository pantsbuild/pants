...
py_class!(class PyTypes |py| {
  ...
  def __new__(
      ...
      construct_file_content_collection: PyObject,
      file_content_collection: PyType,
    ...
    Self::create_instance(
        ...
        construct_file_content_collection: Function(externs::key_for(construct_file_content_collection.into())?),
        file_content_collection: externs::type_for(file_content_collection),

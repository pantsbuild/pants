...
pub enum Metric {
  ...
  RemoteExecutionMethodExecute,
  RemoteExecutionMethodWaitExecution,
...
impl Metric {
  pub fn as_str(&self) -> &'static str {
    ...
    match *self {
      ...
      RemoteExecutionMethodExecute => "remote_execution_method_execute",
      RemoteExecutionMethodWaitExecution => "remote_execution_method_wait_execution",

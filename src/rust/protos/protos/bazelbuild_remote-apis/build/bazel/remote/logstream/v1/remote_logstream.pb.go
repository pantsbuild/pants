...
func file_build_bazel_remote_logstream_v1_remote_logstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_build_bazel_remote_logstream_v1_remote_logstream_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_build_bazel_remote_logstream_v1_remote_logstream_proto_msgTypes[1].Exporter = func(v any, i int) any {

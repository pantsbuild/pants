...
class Distribution:
  ...
  def _compute_home_from_system_properties(self) -> str:
    home: str = self._get_system_properties(self.java)['java.home']
  ...
  def home(self) -> str:
    ...
    if not self._home:
      self._home = self._compute_home_from_system_properties()
    return self._home

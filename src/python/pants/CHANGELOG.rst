...
1.1.0-rc0 (05/15/2016)
----------------------

This will be the first release in the 1.1.x stable branch: only the changes since the
1.1.0-pre0 release are listed below.

Notably, this release contains support for JDK8's javac plugins.

This is also the first release in which the (very) experimental new pants engine and
daemon are integrated with one another in core pants. While we absolutely do not recommend
using the daemon for any production usecases (there is still a long list of known bugs),
...
* [golang] Add a command line option for meta tag resolution
  `RB #3882 <https://rbcommons.com/s/twitter/r/3882>`_

* [golang] Add a Go Plugin README.
  `Issue #README.md <https://github.com/jsirois/pants/blob/jsirois/issues/2482/go-contrib-readme/contrib/go/README.md>`_
...
* PrepCommandIntegration test handles parallel runs.
...
* Add the start of a Jenkins runbook.
  `Issue #RUNBOOK.md <https://github.com/jsirois/pants/blob/jsirois/issues/3352/build-support/ci/RUNBOOK.md>`_
...
* Update packer docs to include canary process.
  `Issue #README.md <https://github.com/jsirois/pants/blob/jsirois/issues/3356/document_canary/build-support/aws/ec2/packer/README.md>`_
...
* [engine] Use the appropriate `BaseGlobs` subclass for excludes
  `Issue #3413), <https://github.com/pantsbuild/pants/issues/3413),>`_

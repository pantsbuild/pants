...
class GlobalOptionsRegistrar(SubsystemClientMixin, Optionable):
  ...
  def register_bootstrap_options(cls, register):
    ...
    register(
      "--v2", advanced=True, type=bool, default=False, help="Enables execution of v2 @goal_rules."
    )
    ...
    register(
      "--pantsd-log-dir", advanced=True, default=None, help="The directory to log pantsd output to."
    )
    register(
  ...
  def register_options(cls, register):
    ...
    register(
      "-x", "--time", type=bool, passive=no_v1, help="Output a timing report at the end of the run."
    )
    register("-e", "--explain", type=bool, passive=no_v1, help="Explain the execution of goals.")

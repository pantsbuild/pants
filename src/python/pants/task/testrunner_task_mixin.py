...
class TestRunnerTaskMixin:
    ...
    def spawn_and_wait(self, test_targets, *args, **kwargs):
        ...
        Other than the required positional test_targets argument, all args and kwargs are passed
        through to spawn.
        """
    ...
    def _validate_target(self, target):
        """Ensures that this target is valid. Raises TargetDefinitionException if the target is
        invalid.

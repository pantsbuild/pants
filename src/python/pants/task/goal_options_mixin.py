...
class GoalOptionsRegistrar(Optionable):
  ...
  def registrar_for_scope(cls, goal):
    ...
    Allows reuse of the same registrar for multiple goals, and also allows us to decouple task code
    from knowing which goal(s) the task is to be registered in.
    """

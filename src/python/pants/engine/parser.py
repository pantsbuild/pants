...
class HydratedStruct:
    ...
    This exists so that the rule graph can statically provide a struct
    for a target, and rules can depend on this without needing to depend
    on having a concrete instance of SymbolTable to register their input
    selectors.
    """

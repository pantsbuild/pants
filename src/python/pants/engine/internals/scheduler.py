...
class Scheduler:
    ...
    def get_timeseries_histograms(self, session):
        return self._native.lib.session_get_timeseries_histograms(self._scheduler, session)
...
class SchedulerSession:
    ...
    def get_timeseries_histograms(self):
        return self._scheduler.get_timeseries_histograms(self._session)

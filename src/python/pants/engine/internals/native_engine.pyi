...
class PathMetadata:
    ...
    @kind.setter
    def kind(self, kind: PathMetadataKind) -> None: ...
    ...
    def is_executable(self, is_executable: bool) -> None: ...

    @property
    def unix_mode(self) -> int | None: ...
    @unix_mode.setter
    def unix_mode(self, unix_mode: int) -> None: ...

    @property
    def accessed(self) -> datetime | None: ...
    @accessed.setter
    def accessed(self, dt: datetime | None) -> None: ...

    @property
    def created(self) -> datetime | None: ...
    @created.setter
    def created(self, dt: datetime | None) -> None: ...

    @property
    def modified(self) -> datetime | None: ...
    @modified.setter
    def modified(self, dt: datetime | None) -> None: ...

    @property
    def symlink_target(self) -> str | None: ...
    @symlink_target.setter
    def symlink_target(self, symlink_target: str | None) -> None: ...

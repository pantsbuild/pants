...
class PyOptionParser:
    ...
    def get_bool(self, option_id: PyOptionId, default: Optional[bool]) -> Optional[bool]: ...
    def get_int(self, option_id: PyOptionId, default: Optional[int]) -> Optional[int]: ...
    def get_float(self, option_id: PyOptionId, default: Optional[float]) -> Optional[float]: ...
    def get_string(self, option_id: PyOptionId, default: Optional[str]) -> Optional[str]: ...
    def get_bool_list(self, option_id: PyOptionId, default: list[bool]) -> list[bool]: ...
    def get_int_list(self, option_id: PyOptionId, default: list[int]) -> list[int]: ...
    def get_float_list(self, option_id: PyOptionId, default: list[float]) -> list[float]: ...
    def get_string_list(self, option_id: PyOptionId, default: list[str]) -> list[str]: ...
    def get_dict(self, option_id: PyOptionId, default: dict[str, Any]) -> dict[str, Any]: ...

...
def tasks_add_query_inputs_filter(tasks: PyTasks, filtered_type: type) -> None: ...
...
def session_wait_for_tail_tasks(scheduler: PyScheduler, session: PySession, timeout_millis: float) -> None: ...

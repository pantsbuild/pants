...
class PyOptionParser:
    ...
    def get_bool(self, option_id: PyOptionId, default: bool) -> bool: ...
    def get_int(self, option_id: PyOptionId, default: int) -> int: ...
    def get_float(self, option_id: PyOptionId, default: float) -> float: ...
    def get_string(self, option_id: PyOptionId, default: str) -> str: ...

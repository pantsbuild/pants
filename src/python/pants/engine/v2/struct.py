...
from pants.engine.v2.addressable import SubclassesOf, SuperclassesOf, addressable, addressable_list
from pants.engine.v2.objects import Serializable, SerializableFactory, Validatable, ValidationError
...
class Struct(Serializable, SerializableFactory, Validatable):
  ...
  def report_validation_error(self, message):
    ...
    :raises: :class:`pants.engine.v2.objects.ValidationError`
    """

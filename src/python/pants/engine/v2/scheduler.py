...
from pants.engine.v2.fs import PathGlobs
from pants.engine.v2.nodes import (DependenciesNode, FilesystemNode, Node, Noop, ProjectionNode,
                                   Return, SelectNode, State, StepContext, TaskNode, Throw, Waiting)
from pants.engine.v2.objects import Closable
...
class ExecutionRequest(datatype('ExecutionRequest', ['roots'])):
  ...
  :type roots: list of :class:`pants.engine.v2.nodes.Node`
  """
...
class LocalScheduler(object):
  ...
  def build_request(self, goals, subjects):
    ...
    :type subject: list of :class:`pants.base.specs.Spec`, `pants.build_graph.Address`, and/or
      :class:`pants.engine.v2.fs.PathGlobs` objects.

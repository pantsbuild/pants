...
from pants.engine.v2.objects import Closable, SerializationError
from pants.engine.v2.scheduler import StepRequest, StepResult
...
class Storage(Closable):
  ...
  `pants.engine.v2.scheduler.StepRequest` and `pants.engine.v2.scheduler.StepResult`

...
from pants.engine.v2.objects import SerializationError
from pants.engine.v2.processing import StatefulPool
...
class Engine(AbstractClass):
  ...
  def __init__(self, scheduler, storage=None, cache=None):
    ...
    :type scheduler: :class:`pants.engine.v2.scheduler.LocalScheduler`
    :param storage: The storage instance for serializables keyed by their hashes.
    :type storage: :class:`pants.engine.v2.storage.Storage`
    ...
    :type cache: :class:`pants.engine.v2.storage.Cache`
    """

...
class TransitiveTargetsRequest:
    ...
    do_traverse_deps_predicate: Callable[[Target], bool] | None
    ...
    def __init__(
        ...
        *,
        include_special_cased_deps: bool = False,
        do_traverse_deps_predicate: Callable[[Target], bool] | None = None,
    ) -> None:
        object.__setattr__(self, "roots", tuple(roots))
        object.__setattr__(self, "include_special_cased_deps", include_special_cased_deps)
        object.__setattr__(self, "do_traverse_deps_predicate", do_traverse_deps_predicate)

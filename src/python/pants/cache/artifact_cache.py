...
def call_use_cached_files(tup):
    """Importable helper for multi-proc calling of
    ArtifactCache.use_cached_files on a cache instance.
...
def call_insert(tup):
    """Importable helper for multi-proc calling of ArtifactCache.insert on an

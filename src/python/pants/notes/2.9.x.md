...
* Use pants config to specify lockfile locations instead of BUILD targets ([#13295](https://github.com/pantsbuild/pants/pull/13295))

* Upgrade to coursier `v2.0.16+73-gddc6d9cc9`. ([#13336](https://github.com/pantsbuild/pants/pull/13336))
...
* Prepare 2.8.0rc1. ([#13408](https://github.com/pantsbuild/pants/pull/13408))

* Improve dynamic UI for Go ([#13412](https://github.com/pantsbuild/pants/pull/13412))

* Prepare 2.7.2rc0. ([#13407](https://github.com/pantsbuild/pants/pull/13407))

* Make `check` output more useful for Go and Java ([#13379](https://github.com/pantsbuild/pants/pull/13379))

* Prepare 2.7.1. ([#13376](https://github.com/pantsbuild/pants/pull/13376))

* Render the coordinates being fetched by `coursier`. ([#13368](https://github.com/pantsbuild/pants/pull/13368))

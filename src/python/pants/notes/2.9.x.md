...
* [internal] Intern using a Python dict, and remove reverse mapping ([#13859](https://github.com/pantsbuild/pants/pull/13859))

* Regenerate tool lock files to pick up their latest transitive dependencies ([#13846](https://github.com/pantsbuild/pants/pull/13846))

* Add symlinked immutable Process inputs ([#13848](https://github.com/pantsbuild/pants/pull/13848))

* [internal] Add support for materializing directory structures as read-only. ([#13857](https://github.com/pantsbuild/pants/pull/13857))

* Turns off validation for unset `SourceFiles` fields if `required=False` ([#13856](https://github.com/pantsbuild/pants/pull/13856))

* JVM Split coordinate and artifact requirement concepts ([#13843](https://github.com/pantsbuild/pants/pull/13843))

* Make pants.pex more useable. ([#13842](https://github.com/pantsbuild/pants/pull/13842))

* [internal] jvm: remove use of `sed` in runner script ([#13847](https://github.com/pantsbuild/pants/pull/13847))

* [internal] Adjust field class names to use Field suffix. ([#13805](https://github.com/pantsbuild/pants/pull/13805))

* [internal] Wheel testing does not override backends. ([#13841](https://github.com/pantsbuild/pants/pull/13841))

* [internal] scala: fix a type in subsystem ([#13837](https://github.com/pantsbuild/pants/pull/13837))

* Support using a `@union` member which is also a subclass of the `@union` as a `Get` input. ([#13833](https://github.com/pantsbuild/pants/pull/13833))

* [internal] add scala debug_goals to pants distribution ([#13831](https://github.com/pantsbuild/pants/pull/13831))
...
* [internal] jvm: fix default paths for tool lockfiles ([#13822](https://github.com/pantsbuild/pants/pull/13822))

* [internal] clean some unused struct fields ([#13824](https://github.com/pantsbuild/pants/pull/13824))

* [internal] java: change phrasing of `fmt` description ([#13826](https://github.com/pantsbuild/pants/pull/13826))

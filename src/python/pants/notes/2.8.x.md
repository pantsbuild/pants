...
* Report ambiguous owners of JVM types ([#13319](https://github.com/pantsbuild/pants/pull/13319))
...
* Upgrade to pyaml 6 + update lockfiles. ([#13287](https://github.com/pantsbuild/pants/pull/13287))
...
* Package local dists into .pex files. ([#13306](https://github.com/pantsbuild/pants/pull/13306))
...
* Demonstrate resources in dists and pexes. ([#13315](https://github.com/pantsbuild/pants/pull/13315))

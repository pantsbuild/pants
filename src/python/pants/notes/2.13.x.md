...
* Switch `use_nailgun` to use a `BTreeSet` ([#15763](https://github.com/pantsbuild/pants/pull/15763))

* Differentiate and propagate missing digest errors ([#15761](https://github.com/pantsbuild/pants/pull/15761))

* [internal] Upgrade the Toolchain Pants Plugin to 0.20.0 ([#15752](https://github.com/pantsbuild/pants/pull/15752))

* Clarify wildcard `AddressInput` error ([#15757](https://github.com/pantsbuild/pants/pull/15757))

* Revert "Add initial Sphinx support with `sphinx_project` target (#15512)" ([#15758](https://github.com/pantsbuild/pants/pull/15758))

* Bump parking_lot from 0.12.0 to 0.12.1 in /src/rust/engine ([#15719](https://github.com/pantsbuild/pants/pull/15719))

* Update release helper to handle the new MacOS ARM64 wheel. ([#15748](https://github.com/pantsbuild/pants/pull/15748))

* Add support for m1 wheel builds in CI. ([#15738](https://github.com/pantsbuild/pants/pull/15738))

* Tweak m1 GHA dummy workflow ([#15739](https://github.com/pantsbuild/pants/pull/15739))

* A dummy GHA job to test our M1 self-hosted runner. ([#15732](https://github.com/pantsbuild/pants/pull/15732))

* Bump libc from 0.2.125 to 0.2.126 in /src/rust/engine ([#15718](https://github.com/pantsbuild/pants/pull/15718))

* Skip more tests that fail on my machine ([#15700](https://github.com/pantsbuild/pants/pull/15700))

* Fix `--changed-since` with directories unknown to Pants when `--changed-dependees` is used ([#15720](https://github.com/pantsbuild/pants/pull/15720))

* Bump petgraph from 0.6.0 to 0.6.2 in /src/rust/engine ([#15717](https://github.com/pantsbuild/pants/pull/15717))

* Bump log from 0.4.16 to 0.4.17 in /src/rust/engine ([#15716](https://github.com/pantsbuild/pants/pull/15716))

* Refactor Dockerfile parsing to be more ergonomic. ([#15692](https://github.com/pantsbuild/pants/pull/15692))

* Prepare 2.12.0rc2 ([#15712](https://github.com/pantsbuild/pants/pull/15712))

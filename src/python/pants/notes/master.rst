...
* Add an :API: public exception for abstract members.
  `Issue #deprecation_policy.md <https://github.com/jsirois/pants/blob/jsirois/issues/3545/src/docs/deprecation_policy.md>`_
...
* [engine] Use scandir, and preserve symlink paths in output
  `Issue #3497).) <https://github.com/pantsbuild/pants/issues/3497).)>`_

...
- [Docker environments](https://www.pantsbuild.org/v2.19/docs/reference-docker_environment) can now pull public images without credentials, and can now handle docker images without Python.

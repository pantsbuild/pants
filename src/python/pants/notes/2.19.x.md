...
[The new `pants.backend.experimental.openapi.lint.openapi_format` backend](https://www.pantsbuild.org/v2.19/docs/reference-openapi-format) supports running [openapi-format](https://github.com/thim81/openapi-format) to format `openapi_...` targets.

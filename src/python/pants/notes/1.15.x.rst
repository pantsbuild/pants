...
As of this release, Pants running under Python 3 and Python 2 have reached implementation and
performance parity! Although Python 3.7 will not be supported in the 1.15.x series, Python 3.6 can

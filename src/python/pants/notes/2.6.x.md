...
* Fallback to `[python-setup].interpreter_constraints` for `python_distribution`s with no first-party dependencies ([#12207](https://github.com/pantsbuild/pants/pull/12207))

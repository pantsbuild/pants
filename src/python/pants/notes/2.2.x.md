...
* Allow newer versions of pytest (6.2.x) ([#11381](https://github.com/pantsbuild/pants/pull/11381))
...
* Add type annotations around Subsystem class ([#11389](https://github.com/pantsbuild/pants/pull/11389))
...
* Support deprecation_start_version in help info. ([#11350](https://github.com/pantsbuild/pants/pull/11350))

...
* Add experimental lockfile support to IPython, Pytest, and Pylint ([#12491](https://github.com/pantsbuild/pants/pull/12491))
...
* Go: refactor Go SDK invocation into common rule ([#12494](https://github.com/pantsbuild/pants/pull/12494))

* Go: dependency inference for packages ([#12484](https://github.com/pantsbuild/pants/pull/12484))

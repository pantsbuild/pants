...
class PexBuilderWrapper:
  ...
  def _resolve_multi(
    ...
    fetchers = [
        ...
        Fetcher([find_links_url]) for find_links_url in find_links
    ]
    ...
    for platform in platforms:
      ...
      resolved_dists = resolve(
        ...
        allow_prereleases=UnsetBool.coerce_bool(python_setup.resolver_allow_prereleases,
                                                default=True),
        use_manylinux=UnsetBool.coerce_bool(python_setup.use_manylinux,
                                            default=True),
      )

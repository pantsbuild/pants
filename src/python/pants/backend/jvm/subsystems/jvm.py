...
class JVM(Subsystem):
  ...
  def register_options(cls, register):
    ...
    register(
      "--program-args", type=list, metavar="<arg>...", help="Run with these extra program args."
    )
    ...
    register(
      ...
      advanced=True,
      type=list,
      default=["-Xdebug", "-Xrunjdwp:transport=dt_socket,server=y,suspend=y,address={debug_port}"],

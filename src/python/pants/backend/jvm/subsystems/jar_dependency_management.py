...
class JarDependencyManagement(Subsystem):
    ...
    def for_target(self, target):
        """Computes and returns the PinnedJarArtifactSet that should be used to manage the given
        target.
...
class JarDependencyManagementSetup(Task):
    ...
    def _compute_artifact_set(self, management_target):
        """Computes the set of pinned artifacts specified by this target, and any of its
        dependencies.

...
class RscCompile(ZincCompile, MirroredTargetOptionMixin):
        ...
        def work_for_vts_rsc(vts, ctx):
            ...
            if not vts.valid:
                ...
                for _conf, classpath_entry in classpath_entries:
                    ...
                    if (
                        self.HERMETIC == self.execution_strategy_enum.value
                        and not classpath_entry.directory_digest
                    ):
        ...
        workflow.resolve_for_enum_variant(
            {
                ...
                "rsc-and-zinc": lambda: rsc_jobs.append(
            ...
            return self.execution_strategy_enum.resolve_for_enum_variant(
                {
                    ...
                    self.NAILGUN: lambda: self._runtool_nonhermetic(
                        wu,
                        self._nailgunnable_combined_classpath,
                        main,
                        tool_name,
                        distribution,
                        ctx,
    ...
    def _jdk_libs_paths_and_digest(self, hermetic_dist):
        ...
        jdk_libs_digest = self.context._scheduler.capture_snapshots((jdk_libs_globs,))[
            0
        ].directory_digest

...
class RunJvmPrepCommandBase(Task):
    ...
    def register_options(cls, register):
        ...
        this opportunity to setup goal validation in JvmPrepCommand
        before the build graph is parsed.
        """
...
class RunBinaryJvmPrepCommand(RunJvmPrepCommandBase):
    """Run code from a JVM compiled language before other tasks in the binary
    goal."""
...
class RunTestJvmPrepCommand(RunJvmPrepCommandBase):
    """Run code from a JVM compiled language before other tasks in the test
    goal."""
...
class RunCompileJvmPrepCommand(RunJvmPrepCommandBase):
    """Run code from a JVM compiled language before other tasks in the compile
    goal."""

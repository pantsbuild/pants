...
class ClasspathUtil:
    ...
    def compute_classpath_entries(cls, targets, classpath_products, extra_classpath_tuples, confs):
        """Return the list of classpath entries for a classpath covering the
        passed targets.
    ...
    def classpath(cls, targets, classpath_products, confs=("default",)):
        """Return the classpath as a list of paths covering all the passed
        targets.
    ...
    def internal_classpath(cls, targets, classpath_products, confs=("default",)):
        """Return the list of internal classpath entries for a classpath
    ...
    def classpath_by_targets(cls, targets, classpath_products, confs=("default",)):
        """Return classpath entries grouped by their targets for the given
        `targets`.
    ...
    def classpath_contents(cls, targets, classpath_products, confs=("default",)):
        """Provide a generator over the contents (classes/resources) of a
        classpath.
    ...
    def classname_for_rel_classfile(cls, class_file_name):
        """Return the class name for the given relative-to-a-classpath-entry
        file, or None."""

...
async def download_pex_bin() -> DownloadedPexBin:
  ...
  url = 'https://github.com/pantsbuild/pex/releases/download/v2.1.0/pex'
  digest = Digest('152c15d9516e78fb5917312acb8e7ebc45a43141366388d39a755eaadc3e4dee', 2609214)

...
@named_rule(name="Compute distribution's 3rd party requirements")
...
@named_rule(name="Find all code to be published in the distribution")
...
@named_rule(name="Get exporting owner for target")
...
@named_rule(name="Set up setuptools")

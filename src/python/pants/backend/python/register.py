...
from pants.backend.python.subsystems.subprocess_environment import rules as subprocess_environment_rules
...
def rules():
  return tuple(python_test_runner.rules() + python_native_code_rules() + subprocess_environment_rules())

    ...
    def register_options(cls, register):
        ...
        register(
            ...
            help=(
                ...
                "as an improvement over constraints file."
            ),
        )
        register(
            ...
            help=(
                ...
                "resolves."
                "\n\nRequires `[python].requirement_constraints` to be set. If you're using the "
                "improved `[python].enable_resolves` feature, this is always the behavior."
            ),
        )
        register(
        ...
        register(
            ...
            help=(
                ...
                "(Git) requirements and local requirements, along with "
                "`[python-repos]` for custom indexes/cheeseshops.\n\n"

                    ...
                    if ":" in v:
                        ...
                        if key.lower() == "path":
                            ...
                            logger.warning(
                                ...
                                "`[python].interpreter_search_paths`, ignoring. This "
                        ...
                        logger.warning(
                            ...
                            "`[python].interpreter_search_paths` is unsupported, ignoring. "
        ...
        for version, source in asdf_versions.items():
            ...
            if install_dir.exists():
                ...
                logger.warning(
                    ...
                    f"`[python].interpreter_search_paths` but `{install_dir}` does not "
        ...
        if pyenv_local:
            ...
            if not local_version_file.exists():
                logger.warning(
                    ...
                    "but <PYENV_LOCAL> was set in `[python].interpreter_search_paths`."
                )
                return []

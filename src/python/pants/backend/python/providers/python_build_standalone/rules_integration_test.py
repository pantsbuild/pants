...
def test_additional_versions(rule_runner, mock_empty_versions_resource):
    ...
    stdout = run_run_request(
        ...
        additional_args=[
            ...
            + "'https://github.com/astral-sh/python-build-standalone/releases/download/20221220/cpython-3.9.16%2B20221220-x86_64-unknown-linux-gnu-install_only.tar.gz|f885f3d011ab08e4d9521a7ae2662e9e0073acc0305a1178984b5a1cf057309a|26767987',"
            + "'https://github.com/astral-sh/python-build-standalone/releases/download/20221220/cpython-3.9.16%2B20221220-x86_64-apple-darwin-install_only.tar.gz|69331e93656b179fcbfec0d506dfca11d899fe5dced990b28915e41755ce215c|17151321',"
            + "]"
        ],
    )
    version = stdout.splitlines()[0]

...
class SetupPyExecutionEnvironment(datatype([
  ...
  def as_environment(self):
    ...
    if native_tools:
      ...
      joined_lib_path = create_path_env_var(all_library_dirs)
      ret['LIBRARY_PATH'] = joined_lib_path

      dynamic_lib_path_env_var = plat.resolve_platform_specific({
        'darwin': lambda: 'DYLD_LIBRARY_PATH',
        'linux': lambda: 'LD_LIBRARY_PATH',
      })
      ret[dynamic_lib_path_env_var] = joined_lib_path

      all_include_dirs = cc.include_dirs + cxx.include_dirs
      ret['CPATH'] = create_path_env_var(all_include_dirs)

      ret['CFLAGS'] = plat.resolve_platform_specific({

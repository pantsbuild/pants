...
class ExportTask(ResolveRequirementsTaskBase, IvyTaskMixin, CoursierMixin):  # type: ignore[misc]
  ...
  def register_options(cls, register):
    ...
    register("--libraries-sources", type=bool, help="Causes libraries with sources to be output.")
    register("--libraries-javadocs", type=bool, help="Causes libraries with javadocs to be output.")
    register(

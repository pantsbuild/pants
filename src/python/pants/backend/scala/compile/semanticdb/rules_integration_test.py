...
from pants.backend.scala.target_types import ScalaArtifactTarget, ScalaSourceTarget, ScalaSourcesGeneratorTarget
...
from pants.jvm.testutil import RenderedClasspath, expect_single_expanded_coarsened_target, make_resolve, maybe_skip_jdk_test
...
@maybe_skip_jdk_test
def test_scala2_compile_with_semanticdb(rule_runner: RuleRunner, scala2_semanticdb_lockfile: JVMLockfileFixture) -> None:
    ...
    assert "META-INF/semanticdb/src/jvm/Foo.scala.semanticdb" in rendered_classpath.content["src.jvm.Foo.scala.scalac.jar"]

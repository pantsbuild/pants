...
class NfpmApkPackage(NfpmPackageTarget):
    ...
    help = help_text(
        ...
        See {doc_url("reference/targets/nfpm_apk_package")}.
        """
    )
...
class NfpmArchlinuxPackage(NfpmPackageTarget):
    ...
    help = help_text(
        ...
        See {doc_url("reference/targets/nfpm_archlinux_package")}.
        """
    )
...
class NfpmDebPackage(NfpmPackageTarget):
    ...
    help = help_text(
        ...
        See {doc_url("reference/targets/nfpm_deb_package")}.
        """
    )
...
class NfpmRpmPackage(NfpmPackageTarget):
    ...
    help = help_text(
        ...
        See {doc_url("reference/targets/nfpm_rpm_package")}.
        """
    )

...
from pants.core.goals.test import Partitions, TestResult
...
def rule_runner() -> RuleRunner:
    return RuleRunner(
        ...
        rules=[
            ...
            *source_root_rules(),
            *target_types_rules(),
            QueryRule(Partitions[HelmUnitTestFieldSet], (HelmUnitTestRequest.PartitionRequest,)),
            QueryRule(TestResult, (HelmUnitTestRequest.SubPartition,)),
        ],
    )

...
class Assembler(datatype(["path_entries", "exe_filename", "runtime_library_dirs", "extra_args"])):
    pass
...
class CCompiler(
    datatype(["path_entries", "exe_filename", "runtime_library_dirs", "include_dirs", "extra_args"])
):
    @property
    def invocation_environment_dict(self):
...
class CppToolchain(datatype([("cpp_compiler", CppCompiler), ("cpp_linker", Linker)])):
    pass

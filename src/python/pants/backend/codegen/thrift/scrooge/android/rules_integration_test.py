...
from pants.backend.codegen.thrift.scrooge.android.rules import GenerateAndroidJavaFromThriftRequest
    ...
    rule_runner = RuleRunner(
        rules=[
            ...
            *stripped_source_files.rules(),
            ...
            QueryRule(GeneratedSources, [GenerateAndroidJavaFromThriftRequest]),
        ],
        target_types=[
            ScalaSourceTarget,
...
def assert_files_generated(
    ...
    *,
    ...
    generated_sources = rule_runner.request(
        GeneratedSources,
        [GenerateAndroidJavaFromThriftRequest(thrift_sources.snapshot, tgt)],
    )
    ...
    rule_runner.write_files(
        {
            "src/thrift/dir1/f.thrift": dedent(
                """\
                #@namespace android org.pantsbuild.example
                struct Person {
                  1: string name
                  2: i32 id
                  3: string email

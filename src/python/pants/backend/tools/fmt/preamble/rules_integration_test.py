...
from pants.backend.tools.fmt.preamble.rules import PreambleRequest, _substituted_template
from pants.backend.tools.fmt.preamble.rules import rules as preamble_rules
...
def run_preamble(rule_runner: RuleRunner, template_by_globs: dict[str, str]) -> FmtResult:
    rule_runner.set_options(
        [
            "--backend-packages=pants.backend.tools.fmt.preamble",

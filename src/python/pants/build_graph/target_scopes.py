...
class Scope(frozenset):
    ...
    It is the responsibility of individual tasks to read and respect
    these scopes by using functions such as target.closure() and
    BuildGraph.closure().
    """
    ...
    def in_scope(self, exclude_scopes=None, include_scopes=None):
        """Whether this scope should be included by the given inclusion and
        exclusion rules.

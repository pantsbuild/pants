...
<project name="${lib.id}" default="compile" basedir=".">
  ...
  <fileset id="${lib.id}.sources" dir="${"${"}java.src.dir}">
  ...
  <target name="_push-single">
    <fail>
      Only bare (non-meta) java_library modules with a provides key can have their artifacts
      pushed.
    </fail>
  </target>
  ...
  <target name="push">
    <fail>
      Only bare (non-meta) java_library modules with a provides key can have their artifacts pushed.
    </fail>
  </target>
  % else:

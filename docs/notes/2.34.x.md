...
Updated memoization of `warn_on_python2_usage_in_interpreter_constraints` to reduce cpu utilization, on large repos this can result in improved performance.

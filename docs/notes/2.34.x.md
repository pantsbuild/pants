...
All versions of [ruff](https://docs.astral.sh/ruff/) from [0.16.8](https://github.com/astral-sh/ruff/releases/tag/0.16.8) to [0.16.8](https://github.com/astral-sh/ruff/releases/tag/0.16.8) are now included in `default_known_versions`.

...
TypeScript and TSX test files are now properly recognized by the `pants test` goal. Previously, only JavaScript and JSX test files worked with the test runner.

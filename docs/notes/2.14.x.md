...
* Add support for string interpolation in Helm deployments (Cherry-pick of #16611) ([#16723](https://github.com/pantsbuild/pants/pull/16723))
...
* More succinct phrasing and better formatting for cli help. ([#16549](https://github.com/pantsbuild/pants/pull/16549))
...
* Deprecate not setting `tailor_pex_binary_targets` explicitly ([#15962](https://github.com/pantsbuild/pants/pull/15962))

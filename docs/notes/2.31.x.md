...
The version of [Pex](https://github.com/pex-tool/pex) used by the Python backend has been upgraded to [`v2.79.0`](https://github.com/pex-tool/pex/releases/tag/v2.79.0). Ofparticular note for Pants users:

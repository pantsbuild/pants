...
- Several core parts of Pants have had their overhead reduced or been ported to Rust.  On operations where execution time it dominated by Pants itself like `dependencies ::` or `lint --only=visibility ::` cold-start speedups on the order of 1.5x have been reported.

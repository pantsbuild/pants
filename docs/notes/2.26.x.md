...
| ------------------------------ | ----------- | ----------- |
| Buildifier                     | "7.1.2"     | "8.0.3"     |
| GolangciLint                   | "1.51.1"    | "1.64.6"    |
| HelmUnitTestSubsystem:         | "0.3.3"     | "0.8.0"     |
| KubeconformSubsystem           | "0.6.2"     | "0.6.7"     |
| NfpmSubsystem                  | "2.38.0"    | "2.41.3"    |
| PyenvPythonProviderSubsystem   | "2.4.7"     | "2.5.3"     |
| Ruff                           | "0.9.6"     | "0.9.10"    |
| Taplo                          | "0.8.0"     | "0.9.3"     |

...
Bug Fix:
- Update default mapping on `pymupdf`, currently `pymudpdf` documentation stated that [`import fitz` is no longer valid](https://pymupdf.readthedocs.io/en/latest/installation.html#problems-after-installation) Fixing [#21517]( https://github.com/pantsbuild/pants/issues/21517) ([#21516] https://github.com/pantsbuild/pants/pull/21516).

...
The default version of `semgrep` used by the `pants.backends.experimental.tool.semgrep` backend is now version 1.72.0. This version requires Python 3.8 or greater.

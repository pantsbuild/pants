...
The documentation and top-level help text for Python tools now contain the default version of the tool, along with instructions on how to override this version using a custom lockfile.

...
The documentation and help text for Python tools now contains the default version of the tool, along with instructions on how to override this version using a custom lockfile.

...
Consider using [Scies](https://github.com/a-scie/jump/blob/main/docs/packaging.md) as an alternative for creating portable Python distributions. This is how Pants itself [is distributed](https://github.com/pantsbuild/scie-pants).
:::

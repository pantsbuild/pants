...
This policy was inspired by the [ghostty AI Assistance Notice]( https://github.com/ghostty-org/ghostty/blob/main/CONTRIBUTING.md).  For further discussion of LLM prose and social contracts see [Using LLMs at Oxide](https://rfd.shared.oxide.computer/rfd/0576).

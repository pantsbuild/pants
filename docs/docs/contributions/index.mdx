...
Before investing your time into a code change, share your ideas so we can give you initial feedback that can save you time (for example, pointing you to related code or prior art).
...
Your change will be included in the next dev release, which usually happens every week or two. If you fixed a bug, your change may also be cherry-picked into a release candidate from the prior release series.

...
# See https://github.com/rspeer/ordered-set for the original implementation.
class OrderedSet:
    ...
```
...
Refer to [MyPy documentation](https://mypy.readthedocs.io/en/stable/getting_started.html) for an explanation of type hints, including some advanced features you may encounter in our codebase like `Protocol` and `@overload`.
...
User documentation uploaded to the [Pantsbuild web docs site](https://www.pantsbuild.org/) consists of two sections:

...
Using doc-strings to document your macros, Pants will pick up and present these for the online help text. Also global constants can be documented using `Annotated`.

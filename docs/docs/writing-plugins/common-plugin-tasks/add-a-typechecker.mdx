...
Refer to [Add a linter](./add-a-linter.mdx). See [`pants/backend/python/typecheck/mypy/rules.py`](https://github.com/pantsbuild/pants/blob/main/src/python/pants/backend/python/typecheck/mypy/rules.py) for an example of MyPy.

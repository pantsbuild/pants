...
See [https://github.com/pantsbuild/pants/blob/master/docs/notes/2.1.x.md](https://github.com/pantsbuild/pants/blob/master/docs/notes/2.1.x.md) for the changelog.
...
See [https://github.com/pantsbuild/pants/blob/master/docs/notes/2.0.x.md](https://github.com/pantsbuild/pants/blob/master/docs/notes/2.0.x.md) for the changelog.

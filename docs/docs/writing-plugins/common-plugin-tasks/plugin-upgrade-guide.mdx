...
See [https://github.com/pantsbuild/pants/blob/master/docs/notes/2.1.x.rst](https://github.com/pantsbuild/pants/blob/master/docs/notes/2.1.x.rst) for the changelog.
...
See [https://github.com/pantsbuild/pants/blob/master/docs/notes/2.0.x.rst](https://github.com/pantsbuild/pants/blob/master/docs/notes/2.0.x.rst) for the changelog.

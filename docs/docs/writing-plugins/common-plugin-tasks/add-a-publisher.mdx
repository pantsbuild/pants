...
In Pants, publishers are responsible for taking built artifacts and pushing them to remote registries or repositories. The `publish` goal is already built into Pants, and your job is to extend it by implementing a publisher for your artifact type.

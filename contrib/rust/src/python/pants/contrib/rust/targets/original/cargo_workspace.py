...
class CargoWorkspace(CargoBase):
  ...
  def __init__(self, address=None, manifest=None, include=None, payload=None, **kwargs):
    ...
    super(CargoWorkspace, self).__init__(
        address=address, manifest=manifest, payload=payload, **kwargs)

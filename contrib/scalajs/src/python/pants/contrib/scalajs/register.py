...
def register_goals():
  # Find the jvm-compile GroupTask (TODO: assert that it already existed) and insert
  # the ScalaJSZincCompile task at the front.
  group = GroupTask.named('jvm-compile', ['unused'])

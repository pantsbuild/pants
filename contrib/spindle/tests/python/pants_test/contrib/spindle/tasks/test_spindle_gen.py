...
class SpindleGenTest(TaskTestBase):
  @classmethod
  def task_type(cls):
    return SpindleGen
  ...
  def setUp(self):
    super(SpindleGenTest, self).setUp()
    self.task_outdir =  os.path.join(self.build_root, 'spindle', 'gen-java')


  def tearDown(self):
    super(SpindleGenTest, self).tearDown()

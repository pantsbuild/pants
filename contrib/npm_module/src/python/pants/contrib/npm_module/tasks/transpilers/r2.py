...
class R2(Transpiler):
  """
    This Task installs the R2 module and performs the RTL transformations in the .css files
  ...
  def prepare(cls, options, round_manager):
    super(R2, cls).prepare(options, round_manager)

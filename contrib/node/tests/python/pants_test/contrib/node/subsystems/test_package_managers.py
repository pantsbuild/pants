...
class TestYarnpkg(unittest.TestCase):
    ...
    def test_add_package_other_options(self, mock_command_gen):
        ...
        for type_option, expected_args in {
            ...
            self.yarnpkg.add_package(package_name, type_option=type_option)
            mock_command_gen.assert_called_once_with(
                [fake_install],
                "yarnpkg",
        ...
        for version_option, expected_args in {
            ...
            self.yarnpkg.add_package(package_name, version_option=version_option)
            mock_command_gen.assert_called_once_with(
                [fake_install],
                "yarnpkg",
                args=["add", package_name] + expected_args,
...
class TestNpm(unittest.TestCase):
    ...
    def test_add_package_other_options(self, mock_command_gen):
        ...
        for type_option, expected_args in {
            ...
            self.npm.add_package(package_name, type_option=type_option)
            mock_command_gen.assert_called_once_with(
                [fake_install],
                "npm",
        ...
        for version_option, expected_args in {
            ...
            self.npm.add_package(package_name, version_option=version_option)
            mock_command_gen.assert_called_once_with(
                [fake_install],
                "npm",

...
class Confluence:
    ...
    def login(confluence_url, user=None, api_entrypoint="confluence2"):
        """Prompts the user to log in to confluence, and returns a Confluence
        object.
    ...
    def get_url(server_url, wiki_space, page_title):
        """return the url for a confluence page in a given space and with a
        given title."""
    ...
    def logout(self):
        ...
        Upon completion, the invoking instance is no longer usable to
    ...
    def getpage(self, wiki_space, page_title):
        ...
        Returns None if the page does not exist or otherwise could not
        be fetched.
        """
        try:
    ...
    def storepage(self, page):
        ...
        returns the stored page, or None if the page could not be
        stored.
        """
        try:
    ...
    def create(self, space, title, content, parent_page=None, **pageoptions):
        ...
        Additional page options available in the xmlrpc api can be
        specified as kwargs. returns the created page or None if the
        page could not be stored. raises ConfluenceError if a parent

  ...
  def test_go_fetch(self):
    with zipfile_server():
      ...
      expected = """
        ...
        Downloading http://127.0.0.1:3000/github.com/fakeuser/rlib1.zip...
        Downloading http://127.0.0.1:3000/github.com/fakeuser/rlib2.zip...
        Invalidated 2 targets.
        Downloading http://127.0.0.1:3000/github.com/fakeuser/rlib3.zip...
        Downloading http://127.0.0.1:3000/github.com/fakeuser/rlib4.zip...
      """
  ...
  def test_go_fetch_failure(self):
    with zipfile_server():
      ...
      expected = """
        ...
        Downloading http://127.0.0.1:3000/github.com/fakeuser/rlib5.zip...

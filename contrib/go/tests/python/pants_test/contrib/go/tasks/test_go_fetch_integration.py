...
class GoFetchIntegrationTest(PantsRunIntegrationTest):
    def test_go_fetch_integration(self):
        args = ["run", "contrib/go/examples/src/go/server"]
    ...
    def test_issues_1998(self):
        ...
        args = ["compile", "contrib/go/examples/3rdparty/go/github.com/AdRoll/goamz:dynamodb"]
    ...
    def test_issues_2229(self):
        ...
        args = ["compile", "contrib/go/examples/3rdparty/go/github.com/robertkrimen/otto"]
        pants_run = self.run_pants(args)
        self.assert_success(pants_run)
